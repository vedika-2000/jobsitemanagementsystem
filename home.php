              ...
              <div class="col-md-4">
                ...
                <div class="block-heading-two">
                  <h3><span>Programes</span></h3>
                        ...
                        Technology is constantly changing. Society as we
                        know it depends on this fact. That whichwe take
                        for granted today would have been the stuff of
                        science fiction as little as fifty yearsago. In fifty
                        years time, we will doubtless be excited, perturbed
                        and baffled by yet more newdevelopments. In the
                        early years of the twenty first century, it is
                        computers and the Internetthat have captured the
                        public imagination, and found their way into not
                        just the workingenvironments, but increasingly into
                        the d
                        the domestic spaces.In this modern society, if we
                        are not capable to cope up with these changes than
                        we are notgoing to stand or survive anywhere in
                        this technical world.               </div>
              <div class="col-md-4">
                <div class="block-heading-two">
                ...
                <div class="block-heading-two">
                  <h3><span>Testimonials</span></h3>
                    ...
                    <div class="active item">
                      <blockquote><p> This project has been mainly designed to overcome
                                        some of the problems faced with the previous
                                        system. The main problem faced was unnecessary
                                        delay in generating the required information by all
                                        unnecessary fields into consideration. It provides
                                        an efficient way to pass the information between
                                        different users to cater their needs. It is a Complete
                                        Portal for Job seekers and employers.</p></blockquote>
                      <div class="carousel-info">
                      <img alt="" src="plugins/home-plugins/img/slides/4.jpg" class="pull-left">
                      <div class="pull-left">
                        <span class="testimonials-name"> PM Chavhan</span>
                        <span class="testimonials-post">Subject Lecturer</span>
                      </div>
                      </div>
                    </div>
                  </div>
